...
def upgrade() -> None:
    op.add_column('intro_facilitations', sa.Column('expires_at', sa.DateTime(timezone=True), nullable=True))
    op.create_index('idx_intro_expires', 'intro_facilitations', ['expires_at'], unique=False)
