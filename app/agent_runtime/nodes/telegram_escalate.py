...
def format_escalation_message(event_type: str, priority: str, findings_count: int, summary: str) -> str:
...
async def send_escalation(event_type: str, priority: str, findings_count: int, summary: str) -> None:
    import os
