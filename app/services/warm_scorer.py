...
def compute_warm_score(contact: Contact, connector_profile: ConnectorProfile | None, target_role: str | None=None) -> WarmScoreResult:
    ...
    return WarmScoreResult(total_score=total, recency_score=recency, relationship_score=relationship, role_score=role, tenure_score=tenure, factors=factors)
...
def compute_referral_score(contact: Contact, user_profile: ConnectorProfile | None, target_role: str | None=None) -> ReferralScoreResult:
    ...
    if ws.total_score >= 70:
        ...
        likelihood = 'low'
    return ReferralScoreResult(total_score=ws.total_score, recency_score=ws.recency_score, relationship_score=ws.relationship_score, role_score=ws.role_score, tenure_score=ws.tenure_score, referral_likelihood=likelihood, factors=ws.factors)

@timed('warm_score_batch')
