...
def compute_warm_score(
    ...
    tenure = compute_tenu[RESEND_KEY_REDACTED]()
...
async def batch_compute_scores(
    ...
    for contact in contacts:
        ...
        if existing:
            ...
            existing.tenu[RESEND_KEY_REDACTED] = Decimal(str(ws_result.tenu[RESEND_KEY_REDACTED]))
            existing.sco[RESEND_KEY_REDACTED] = ws_result.factors
            ...
            ws = WarmScore(
                ...
                tenu[RESEND_KEY_REDACTED]=Decimal(str(ws_result.tenu[RESEND_KEY_REDACTED])),
                sco[RESEND_KEY_REDACTED]=ws_result.factors,
