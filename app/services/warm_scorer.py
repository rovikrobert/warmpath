...
def compute_warm_score(
    ...
    return WarmScoreResult(
        ...
        role_score=role,
        tenu[RESEND_KEY_REDACTED]=tenure,
        factors=factors,
    )
...
def compute_referral_score(
    ...
    return ReferralScoreResult(
        ...
        tenu[RESEND_KEY_REDACTED]=ws.tenu[RESEND_KEY_REDACTED],
    ...
    for contact in contacts:
        ...
        if existing:
            ...
            ws = WarmScore(
                ...
                tenu[RESEND_KEY_REDACTED]=Decimal(str(ref_result.tenu[RESEND_KEY_REDACTED])),
                sco[RESEND_KEY_REDACTED]=ref_result.factors,
