...
BOARD_REGISTRY: dict[str, dict[str, str]] = {
    ...
    "sea-group": {"career_page": "https://careers.sea.com/"},
    "shopee": {"career_page": "https://careers.shopee.sg/"},
    "lazada": {"career_page": "https://www.lazada.com/en/careers/"},
    "gojek": {"career_page": "https://www.gojek.com/en-id/careers/"},
    ...
    "syfe": {"lever": "syfe"},
    "aspire": {"career_page": "https://aspireapp.com/careers"},
    "funding-societies": {"career_page": "https://fundingsocieties.com/careers"},
    "carro": {"career_page": "https://www.carro.co/careers"},
    # --- India ---
