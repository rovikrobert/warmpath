...
def _befo[RESEND_KEY_REDACTED](conn, cursor, statement, parameters, context, executemany):  # noqa: ANN001
...
def install_db_instrumentation(sync_engine) -> None:  # noqa: ANN001
    ...
    event.listen(sync_engine, "befo[RESEND_KEY_REDACTED]", _befo[RESEND_KEY_REDACTED])
