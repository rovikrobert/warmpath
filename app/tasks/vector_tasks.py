...
async def _sync_contacts_for_user(
    ...
    try:
        ...
        sco[RESEND_KEY_REDACTED] = await _load_warm_scores(user_id, [c.id for c in contacts], db)
                ...
                payloads.append(
                    {
                        ...
                        "warm_score": sco[RESEND_KEY_REDACTED].get(c.id, 0.0),
