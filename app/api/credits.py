...
async def purchase_credits(
    ...
    await enforce_daily_limit(
        ...
        error_message=f"Credit purchase limit reached ({settings.RATE_LIMIT_CREDIT_PURCHASES_PER_DAY}/day)",
    )
...
async def trigger_expiry(
    ...
    await enforce_daily_limit(
        ...
        db,
        is_admin=current_user.is_admin,
        error_message=f"Credit expiry limit reached ({settings.RATE_LIMIT_CREDIT_EXPIRE_PER_DAY}/day)",
    )
