...
// ---------------------------------------------------------------------------
let _usageWarningCallback: ((msg: string) => void) | null = null;
const _shownWarnings = new Set();

export function onUsageWarning(cb: (msg: string) => void) {
...
async function _rawFetch(path: string, options: any = {}) {
...
export const contacts = {
  ...
  getLatestUpload: () => api('/api/v1/contacts/uploads/latest'),
  list: (params = {}) => {
