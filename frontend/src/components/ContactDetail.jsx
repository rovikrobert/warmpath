              ...
              {detail.score_breakdown && (
                <div className="mt-2 grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                  {detail.score_breakdown.recency != null && (
                    <div className="flex justify-between"><span className="text-slate-500">Recency (35%)</span><span className="text-slate-300">{detail.score_breakdown.recency}</span></div>
                  )}
                  {detail.score_breakdown.relationship != null && (
                    <div className="flex justify-between"><span className="text-slate-500">Relationship (30%)</span><span className="text-slate-300">{detail.score_breakdown.relationship}</span></div>
                  )}
                  {detail.score_breakdown.role_relevance != null && (
                    <div className="flex justify-between"><span className="text-slate-500">Role relevance (20%)</span><span className="text-slate-300">{detail.score_breakdown.role_relevance}</span></div>
                  )}
                  {detail.score_breakdown.tenure != null && (
                    <div className="flex justify-between"><span className="text-slate-500">Time at company (15%)</span><span className="text-slate-300">{detail.score_breakdown.tenure}</span></div>
                  )}
                </div>
              )}
            </>
