  ...
  return (
    <div className="flex h-screen bg-slate-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden lg:overflow-visible">
        ...
        <footer className="hidden lg:block border-t border-slate-700/50 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-slate-700/50 bg-slate-900 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] lg:hidden">
