...
export default function SourceTag({ source, label, compact = false }) {
  return (
    <Tooltip content={source} position="top">
      <span className="inline-flex cursor-help items-center gap-1 text-xs text-slate-500 underline decoration-dotted underline-offset-2">
        {!compact && (
