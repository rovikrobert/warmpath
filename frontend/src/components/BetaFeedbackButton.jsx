...
export default function BetaFeedbackButton() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-20 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-amber-500 text-white shadow-lg hover:bg-amber-400 transition-colors lg:bottom-6"
      >
  ...
  return (
    <div
      className="fixed bottom-20 right-6 z-50 w-80 rounded-xl bg-slate-900 border border-slate-700/50 shadow-lg lg:bottom-6"
      role="dialog"
