    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6" role="main">
        ...
        <section className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-secondary-foreground">
            {content.heroSub}
          </p>
          {content.heroSource && (
            <div className="mt-2">
        ...
        <section className="mb-12" aria-label="How it works">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {content.steps.map((item) => (
              ...
              >
                <div className="mx-auto mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-sm font-bold text-primary">
                  {item.step}
                </div>
        ...
        <section
          className="mb-12 rounded-xl border border-border bg-card"
        ...
        >
          ...
          >
            ...
            <svg
              className={`h-5 w-5 text-muted-foreground transition-transform ${showExplainer ? "rotate-180" : ""}`}
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="2"
              stroke="currentColor"
        ...
        <section className="text-center" aria-label="Sign up">
          ...
          <p className="mt-3 text-sm text-muted-foreground">{content.ctaSub}</p>
        </section>
      </main>
