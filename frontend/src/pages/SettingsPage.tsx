    ...
    <>
      ...
      <div className="mb-6 surface-raised p-6">
        ...
        <div className="mt-3 flex flex-col gap-3 sm:flex-row">
          ...
          <button type="button" disabled title="Coming soon" className="w-full sm:w-auto rounded-lg bg-info px-4 py-2 text-sm font-medium text-white opacity-50 cursor-not-allowed" aria-disabled="true">
