...
function SectionHeading({ id, children }) {
  return (
    <h2 id={id} className="scroll-mt-24 text-xl font-bold text-foreground">
      {children}
    </h2>
  );
}
...
function Paragraph({ children }) {
  return <p className="text-sm leading-relaxed text-secondary-foreground">{children}</p>;
}
...
function BulletList({ items }) {
  return (
    <ul className="space-y-1.5 pl-5">
      {items.map((item, i) => (
        <li key={i} className="list-disc text-sm leading-relaxed text-secondary-foreground">
          {item}
        </li>
      ))}
    </ul>
...
export default function PrivacyPage() {
  ...
  return (
    ...
    <main className="mx-auto max-w-3xl space-y-8 px-4 py-8 pb-16 sm:px-6">
      ...
      {/* Table of Contents */}
      <nav className="rounded-xl bg-card p-5 border border-border" aria-label="Table of contents">
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="commitment">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">1</span>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="four-parties">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">2</span>
          The Four Parties
        </SectionHeading>
        <Paragraph>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="collect">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">3</span>
          Information We Collect
        </SectionHeading>
        <div className="space-y-3">
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Account Information</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Contact Data (CSV Upload)</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Usage Data</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Cookies</h4>
            <Paragraph>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="use">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">4</span>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="vault">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">5</span>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border-l-4 border-primary bg-primary/10 p-4">
            <h4 className="mb-1 font-semibold text-foreground">Private Vault</h4>
        ...
        <div>
          ...
          <ol className="space-y-2 pl-5">
            {[
              ...
              <li key={i} className="list-decimal text-sm leading-relaxed text-secondary-foreground">
                {step}
              </li>
            ))}
          </ol>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="sharing">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">6</span>
          Data Sharing
        </SectionHeading>
        <Paragraph>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="suppression">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">7</span>
          Suppression List
        </SectionHeading>
        <Paragraph>
        ...
        <Paragraph>
          ...
          <a href="mailto:rovik@majiq.agency" className="font-medium text-primary hover:text-primary">
            rovik@majiq.agency
          </a>{' '}
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="rights">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">8</span>
          Your Rights
        </SectionHeading>
        <Paragraph>
        ...
        {/* Tabs */}
        <div className="flex gap-1 overflow-x-auto rounded-lg bg-muted p-1" role="tablist" aria-label="Privacy rights by jurisdiction">
          {[
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="ai">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">9</span>
        ...
        <div className="space-y-3">
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">AI Coaching & Message Drafting</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">CSV Data Normalisation</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Resume Parsing</h4>
            <Paragraph>
          ...
          <div>
            <h4 className="mb-1 font-semibold text-foreground">Cultural Context Engine</h4>
            <Paragraph>
        ...
        <div className="overflow-x-auto">
          <h4 className="mb-2 font-semibold text-foreground">Our AI Providers</h4>
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted text-left">
                <th className="px-3 py-2 font-semibold text-secondary-foreground">Provider</th>
                <th className="px-3 py-2 font-semibold text-secondary-foreground">What It Does</th>
                <th className="px-3 py-2 font-semibold text-secondary-foreground">Data Sent</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {[
                ...
                <tr key={i} className="hover:bg-muted">
                  <td className="px-3 py-2 font-medium text-foreground">{provider}</td>
                  <td className="px-3 py-2 text-muted-foreground">{purpose}</td>
                  <td className="px-3 py-2 text-muted-foreground">{data}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="retention">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">10</span>
          Data Retention
        </SectionHeading>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted text-left">
                <th className="px-3 py-2 font-semibold text-secondary-foreground">Data Type</th>
                <th className="px-3 py-2 font-semibold text-secondary-foreground">Retention Period</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {[
      ...
      <section className="space-y-4 rounded-xl bg-card p-6 border border-border">
        <SectionHeading id="contact">
          <span className="mr-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 text-sm text-primary">11</span>
          Contact Us
        </SectionHeading>
        <div className="space-y-2">
          <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-primary/30 bg-primary/10 p-3">
            <p className="text-sm text-primary">
              ...
              <a href="mailto:rovik@majiq.agency" className="font-medium text-primary hover:underline">
                rovik@majiq.agency
              </a>.
            </p>
          </div>
