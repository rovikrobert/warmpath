  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      >
        ...
        {/* Error state */}
        {!loading && error && (
          <section className="rounded-xl border border-slate-700/50 bg-slate-900 p-8 text-center">
            ...
            <Link
              ...
              className="inline-block rounded-lg bg-amber-500 px-5 py-2 text-sm font-medium text-white hover:bg-amber-400"
            >
              Join WarmPath
            </Link>
          </section>
        ...
        {/* Success state */}
        {!loading && !error && data && (
          <section className="rounded-xl border border-slate-700/50 bg-slate-900 p-8">
            {/* Intro card */}
            ...
            {/* Divider */}
            <div className="mb-6 border-t border-slate-700/50" />

            {/* CTAs */}
            <div className="space-y-3">
              <p className="flex w-full items-center justify-center gap-2 rounded-lg bg-amber-500/10 border border-amber-500/30 px-5 py-2.5 text-sm font-medium text-amber-400">
                <svg
                  className="h-4 w-4"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <Link
                ...
                className="flex w-full items-center justify-center rounded-lg border border-slate-600 px-5 py-2.5 text-sm font-medium text-slate-300 hover:border-slate-500 hover:text-slate-200"
              >
                Join WarmPath
              </Link>
            </div>
