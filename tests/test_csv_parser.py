...
class TestParseLinkedinCsv:
    ...
    def test_names_a[RESEND_KEY_REDACTED](self):
        contacts = parse_linkedin_csv(SAMPLE_CSV.encode("utf-8"))
        eve = contacts[4]
    ...
    def test_rows_without_names_a[RESEND_KEY_REDACTED](self):
...
async def test_contacts_a[RESEND_KEY_REDACTED](client: AsyncClient):
