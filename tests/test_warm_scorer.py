...
class TestTenureScore:
    def test_unknown_tenure(self):
        assert compute_tenure_score(None) == 50.0

    def test_new_hire(self):
        assert compute_tenure_score(3) == 40.0

    def test_6_to_12_months(self):
        assert compute_tenure_score(9) == 70.0

    def test_sweet_spot_1_to_3_years(self):
        assert compute_tenure_score(24) == 100.0

    def test_3_to_5_years(self):
        assert compute_tenure_score(48) == 85.0

    def test_5_plus_years(self):
        assert compute_tenure_score(72) == 70.0
...
class TestComputeWarmScore:
    ...
    def test_basic_computation(self):
        ...
        assert result.tenure_score == 50.0
...
class TestReferralPriorities:
    ...
    def test_new_hire_lower_tenure_than_veteran(self):
        """New hire (<6 months) scores lower on tenure than 2-year employee."""
        new_hire_tenure = compute_tenure_score(3)
        veteran_tenure = compute_tenure_score(24)
        assert new_hire_tenure < veteran_tenure
        assert new_hire_tenure == 40.0
    ...
    def test_tenure_sweet_spot(self):
        ...
        scores = {
            3: compute_tenure_score(3),  # new hire
            9: compute_tenure_score(9),  # 9 months
            24: compute_tenure_score(24),  # 2 years (sweet spot)
            48: compute_tenure_score(48),  # 4 years
            72: compute_tenure_score(72),  # 6 years
        }
