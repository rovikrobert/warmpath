...
class TestBusinessOutcomes:
    def test_sco[RESEND_KEY_REDACTED](self):
        ...
        score = sco[RESEND_KEY_REDACTED]([HELP_JOB_SEEKERS])
        assert score > 0

    def test_sco[RESEND_KEY_REDACTED](self):
        from agents.shared.business_outcomes import sco[RESEND_KEY_REDACTED]

        assert sco[RESEND_KEY_REDACTED]([]) == 0.0

    def test_sco[RESEND_KEY_REDACTED](self):
        from agents.shared.business_outcomes import OUTCOME_PRIORITY, sco[RESEND_KEY_REDACTED]

        score = sco[RESEND_KEY_REDACTED](OUTCOME_PRIORITY)
        assert score > 0
        assert score <= 1.0
    ...
    def test_sco[RESEND_KEY_REDACTED](self):
        ...
        high = sco[RESEND_KEY_REDACTED]([HELP_JOB_SEEKERS])
        low = sco[RESEND_KEY_REDACTED]([COST_EFFICIENCY])
        assert high > low
