...
class TestProductManagerScan:
    ...
    def test_scan_has_feature_coverage(self):
        from product_team.product_manager.product_manager import scan
        report = scan()
        assert "feature_coverage_score" in report.metrics
...
class TestCosIntegration:
    ...
    def test_product_categories_in_outcome_map(self):
        ...
        product_categories = ["ux_quality", "design_system", "feature_coverage",
    ...
    def test_product_outcomes_score(self):
        from agents.shared.business_outcomes import get_aligned_outcomes, score_alignment
