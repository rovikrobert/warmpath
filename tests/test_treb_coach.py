...
async def nh_auth_headers(client: AsyncClient) -> dict:
    """Create a test user with share_network intent and return auth headers."""
...
class TestPersonaRouting:
    ...
    def test_share_network_returns_treb(self):
        from app.api.coach import _resolve_persona
    ...
    def test_explore_default_keevs(self):
        from app.api.coach import _resolve_persona
    ...
    def test_explore_nh_topic_returns_treb(self):
        from app.api.coach import _resolve_persona
